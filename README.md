...
[![SearXNG](https://img.shields.io/badge/SearXNG-2026.08.06-blue)](https://github.com/searxng/searxng)
[![Python](https://img.shields.io/badge/Python-3.11+-green)](https://www.python.org/)
[![License](https://img.shields.io/badge/License-AGPL--3.0-orange)](LICENSE)

**SearXNG for Windows** — 原生 Windows 移植版，无需 WSL、Docker 或虚拟机，开箱即用。

> 本仓库基于 [SearXNG](https://github.com/searxng/searxng) 官方最新版本 **[`2026.08.06` (b023a28bab)](https://github.com/searxng/searxng)** 深度适配 Windows 环境。
...
| 项目 | 版本 |
|------|------|
| SearXNG 源码 | **[`2026.08.06`](https://github.com/searxng/searxng/commit/b023a28bab)** — 官方最新 master |
...
| `searx/botdetection/trusted_proxies.py` | `trusted_proxies` 为空时跳过判断，避免误伤直连 IP |
...
1. ✅ **源码全面替换** — 从旧版私有分支升级到官方 `2026.08.06`（b023a28bab）
